...
from hotzenplotz.openstack.common import local
...
The current message format (version 2.0) is very simple.  It is:
    ...
    {
        'hotzenplotz.version': <RPC Envelope Version as a String>,
        'hotzenplotz.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'hotzenplotz.version'
_MESSAGE_KEY = 'hotzenplotz.message'
